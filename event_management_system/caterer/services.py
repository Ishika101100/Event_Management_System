...
def get_venues():
    ...
    venue_get_caterer_obj_true = venue_get_caterer_obj_for_caterer(caterer_id=current_caterer.id,
                                                                   is_approved_caterer=True)
    venue_get_caterer_obj_false = venue_get_caterer_obj_for_caterer(caterer_id=current_caterer.id,
                                                                    is_approved_caterer=False)
    venue_get_caterer_obj_none = venue_get_caterer_obj_for_caterer(caterer_id=current_caterer.id,
